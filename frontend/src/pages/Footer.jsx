      ...
      <div className="mx-auto max-w-7xl px-4 grid gap-10 md:grid-cols-4 relative">
        <div>
          ...
          <p className="text-white/70 text-sm max-w-xs">
            Robust cybersecurity engineering for modern product teams.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <form className="flex gap-2">
            <input
              className="flex-1 rounded-md bg-white/10 px-3 py-2 placeholder-white/50 outline-none"
              placeholder="Enter your email"
            />
            <button className="rounded-md bg-white text-black px-4">
              Send
            </button>
          </form>
        </div>
      </div>
      <div className="mx-auto max-w-7xl px-4 mt-10 text-white/50 text-xs">
