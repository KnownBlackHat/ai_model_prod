...
function Pricing() {
    return (
        ...
        >
            <div className="absolute inset-0 overflow-hidden bg-black text-white min-h-screen min-w-screen bg-cover  bg-center -z-10 rotate-180"
                style={{ backgroundImage: 'url("./bg.png")' }}
            />

            <section id="pricing" className="text-white py-24 min-h-screen items-center flex">
