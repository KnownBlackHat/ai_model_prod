...
function CreateAcc() {
  ...
  return (
    <section
      className="text-white bg-black py-24 min-h-screen items-center flex justify-center"
      style={{ backgroundImage: 'url("./bg.png")' }}
    >
      <div className="flex flex-col">
        <h1 className="text-3xl md:text-6xl px-3 text-center">
          Create Account
        </h1>
        <div className="bg-white/15 px-12 pt-12 pb-6 rounded-xl mt-4">
          ...
          <label
            htmlFor="password"
            className="mt-6 block text-sm font-medium  text-white/60"
          >
            Password
          </label>
          <input
          ...
          <div className="flex justify-between mt-8">
            ...
            <button
              ...
              className="underline-offset-4 font-bold underline p-2 rounded-lg"
            >
              Already have account?
            </button>
          </div>
          <div className="mt-8 w-full flex items-center text-center justify-center">
            <GoogleLogin
              onSuccess={OnSuccess}
              onError={OnError}
              size="large"
