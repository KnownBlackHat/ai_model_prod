...
function Niva() {
  return (
    <section
      id="niva"
      className="relative overflow-hidden bg-black text-white py-24 bg-cover bg-center min-h-screen flex items-center"
      ...
      <div className="relative mx-auto max-w-7xl px-4 grid gap-10 md:grid-cols-2 items-center">
        ...
        <div>
          ...
          <h2 className="mt-4 text-4xl md:text-7xl font-semibold leading-[1.1] text-left">
            <span className="bg-gradient-to-b font-thin from-cyan-300 to-cyan-500 bg-clip-text text-transparent">
              Meet Niva
            </span>
            <br /> unlock the new
          ...
          <p className="mt-5 text-white/80 text-sm max-w-md">
            Meet your ultimate AI companion – a smart, speaking, listening model
            built to solve everything!
          </p>
          ...
          <div className="mt-6 flex items-center gap-3">
            <div className="flex -space-x-3">
              {["#fca5a5", "#fde047", "#60a5fa", "#c084fc", "#34d399"].map(
                (c, idx) => (
                  <div
                    key={idx}
